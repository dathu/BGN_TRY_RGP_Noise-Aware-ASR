function enhanced_signal = mss_smpr(x, Srate, method)
% MSS_SMPR  Speech enhancement using MSS-SMPR with MCRA noise estimation
%
% Inputs:
%   x       : noisy speech signal (Nx1)
%   Srate   : sampling frequency
%   method  : noise estimation method (e.g., 'mcra')
%
% Output:
